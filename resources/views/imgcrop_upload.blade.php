...
var sec1,sec2,sec3,sec2_ar,sec3_ar, sec4, sec5;
...
type: "POST",
dataType: "json",
url: "crop-image-upload_port",
data: {'_token': $('meta[name="_token"]').attr('content'), 'image': base64data,'url':$('.img_dest').val(),'sec2':sec2,'sec3':sec3,'sec2_ar':sec2_ar,'sec3_ar':sec3_ar,'sec4':sec4,'sec5':sec5}, 
...
dataType: "json",
url: "crop-image-upload_port",
data: {'_token': $('meta[name="_token"]').attr('content'),'nocrop':'nocrop','image':base64,'url':$('.img_dest').val(),'sec2':sec2,'sec3':sec3,'sec2_ar':sec2_ar,'sec3_ar':sec3_ar,'sec4':sec4,'sec5':sec5}, 
success: function(data){
    $(".b_b").attr('src',base64);
    $moda_l.modal('hide');
}
