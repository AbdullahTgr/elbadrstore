        ...
        <div class="col-12">
          <div style=" padding: 10px; " class="card shadow">
            ...
            <div class="card-header border-0">
              <h4 class="mb-0">contactus List</h4>
              <br>
            </div> 
                        ...
                        <th scope="row">
                          <div class="d-flex px-2 py-1">
                            <div class="d-flex flex-column justify-content-center">
                              <a href="{{route('profile',$contactus->id)}}" class="mb-0 text-sm">{{$contactus->contactus}}</a>
                            </div>
                          </div>
                        </th>
                        <td class="text-right">
                          <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                              @if (Auth::user()->role == 1)
                                <li><a class="dropdown-item del"  data-bs-toggle="modal" data-bs-target="#delete" href="#"><input type="hidden" class="id" value="{{$contactus->id}}" >Delete</a></li>
                                <li><a class="dropdown-item getid" data-bs-toggle="modal" data-bs-target="#edit" href="#"><input type="hidden" class="id" value="{{$contactus->id}}" ><input type="hidden" class="name" value="{{$contactus->contactus}}" >Edit</a></li>
                              @endif
                             </ul>
                          </div>
...
@include('contactus.delete')
@include('contactus.edit')
@include('contactus.add')
