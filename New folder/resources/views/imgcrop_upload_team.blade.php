...
var sec1,sec2,sec3, sec4, sec5,sec6,sec7, sec8, sec9;
...
data: {'_token': $('meta[name="_token"]').attr('content'), 'image': base64data,'url':$('.img_dest').val(),'sec2':sec2,'sec3':sec3,'sec4':sec4,'sec6':sec6,'sec7':sec7,'sec8':sec8}, 
...
dataType: "json",
url: "crop-image-upload_team",
data: {'_token': $('meta[name="_token"]').attr('content'),'nocrop':'nocrop','image':base64,'url':$('.img_dest').val(),'sec1':sec1,'sec2':sec2,'sec3':sec3,'sec4':sec4,'sec6':sec6,'sec7':sec7,'sec8':sec8}, 
success: function(data){
    $(".b_b").attr('src',base64);
    $moda_l.modal('hide');
}
